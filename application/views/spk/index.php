...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
        <a href="<?= base_url('spk/buat') ?>" class="btn btn-primary btn-block mb-3"><i class="fas fa-pen mr-2"></i>Buat Surat SPK Baru</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <?php if ($item['status_surat'] == 'Menunggu') : ?>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('spk/terima/') . $item['id_spk'] ?>">Selesai Dibuat</a>
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('spk/tolak/') . $item['id_spk'] ?>">Tolak Surat</a>
                            </div>
                          </div>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('spk/detail/') . $item['id_spk'] ?>" class="btn btn-info"><i class="fas fa-eye mr-2"></i>Lihat</a>
                        <a href="<?= base_url('spk/edit/') . $item['id_spk'] ?>" class="btn btn-success"><i class="fas fa-edit mr-2"></i>Edit</a>
                        <a href="<?= base_url('spk/hapus/') . $item['id_spk'] ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger"><i class="fas fa-trash mr-2"></i>Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
