      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('spk') ?>">SPK</a></li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $spk->nama_mhs ?></h5>
              <h6><?= $spk->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($spk->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
            <div class="mailbox-controls with-border text-center">
              ...
              <button type="button" onclick="cetak_spk('<?= base_url('spk') ?>/cetak_pdf/<?= $spk->id_spk ?>')" class="btn btn-default btn-sm" title="Print">
                <i class="fas fa-print mr-2"></i>Cetak Surat
              </button>
							<?php endif ?>
              <a href="<?= base_url('spk/download_pdf/') . $spk->id_spk ?>" target="__blank" class="btn btn-default btn-sm" title="Download PDF">
