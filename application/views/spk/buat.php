              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="kelas_asal" class="form-control" id="kelas_asal" placeholder="Kelas Asal :" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label for="kelas_tujuan">Kelas Tujuan</label>
                    <input type="text" name="kelas_tujuan" class="form-control" id="kelas_tujuan" placeholder="Kelas Tujuan :" required>
                  </div>
                  <div class="form-group col-md-4">
