      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('skl') ?>">SKL</a></li>
        ...
        <div class="card bg-gradient-primary">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $skl->nama_mhs ?></h5>
              <h6><?= $skl->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($skl->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
            <div class="mailbox-controls with-border text-center">
              ...
              <button type="button" onclick="cetak_skl('<?= base_url('skl') ?>/cetak_pdf/<?= $skl->id_skl ?>')" class="btn btn-default btn-sm" title="Print">
                <i class="fas fa-print mr-2"></i>Cetak Surat
              </button>
							<?php endif ?>
              <a href="<?= base_url('skl/download_pdf/') . $skl->id_skl ?>" target="__blank" class="btn btn-default btn-sm" title="Download PDF">
