            ...
            <div class="card-footer">
              <div class="row d-flex justify-content-between">
                <div class="col-sm-3 border-right">
                  <a href="<?= base_url('prodi') ?>" class="text-light">
                    <div class="description-block">
                      <h5 class="description-header">PRODI</h5>
                      <span class="description-text"><?= $total_prodi ?> Total</span>
                    </div>
                  </a>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-3 border-right">
                  <a href="<?= base_url('kaprodi') ?>" class="text-light">
                    <div class="description-block">
                      <h5 class="description-header">KAPRODI</h5>
                      <span class="description-text"><?= $total_kaprodi ?> Total</span>
                    </div>
                  </a>
                  <!-- /.description-block -->
                </div>
                <div class="col-sm-3">
                  <a href="<?= base_url('user') ?>" class="text-light">
                    <div class="description-block">
                      <h5 class="description-header">USER</h5>
                      <span class="description-text"><?= $total_user ?> Total</span>
                    </div>
                  </a>
                  <!-- /.description-block -->
                </div>
