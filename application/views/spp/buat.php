      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?= base_url('spp/proses_buat') ?>" method="post">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="prodi_asal" class="form-control bg-light" id="prodi_asal" placeholder="Prodi Asal :" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label for="prodi_tujuan">Prodi Tujuan</label>
                    <input type="text" name="prodi_tujuan" class="form-control bg-light" id="prodi_tujuan" placeholder="Prodi Tujuan :" required>
                  </div>
                  <div class="form-group col-md-4">
