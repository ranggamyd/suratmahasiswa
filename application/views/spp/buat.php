              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="prodi_asal" class="form-control" id="prodi_asal" placeholder="Prodi Asal :" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label for="prodi_tujuan">Prodi Tujuan</label>
                    <input type="text" name="prodi_tujuan" class="form-control" id="prodi_tujuan" placeholder="Prodi Tujuan :" required>
                  </div>
                  <div class="form-group col-md-4">
