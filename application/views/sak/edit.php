            ...
            <input type="hidden" name="id" value="<?= $sak->id_sak ?>">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="no_surat" value="<?= $sak->no_surat ?>" class="form-control" id="no_surat" placeholder="No. Surat :" readonly required>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                  ...
                  <textarea name="body_surat" id="summernote" class="form-control" style="height: 300px" required><?= $sak->body_surat ?></textarea>
                </div>
              </div>
              <!-- /.card-body -->
