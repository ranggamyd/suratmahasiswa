                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('sak/detail/') . $item['id_sak'] ?>" class="btn btn-info"><i class="fas fa-eye mr-2"></i>Lihat</a>
                        <a href="<?= base_url('sak/edit/') . $item['id_sak'] ?>" class="btn btn-success"><i class="fas fa-edit mr-2"></i>Edit</a>
                        <a href="<?= base_url('sak/hapus/') . $item['id_sak'] ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger"><i class="fas fa-trash mr-2"></i>Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
