      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('sak') ?>">SAK</a></li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $sak->nama_mhs ?></h5>
              <h6><?= $sak->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($sak->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
            <div class="mailbox-controls with-border text-center">
              ...
              <button type="button" onclick="cetak_sak('<?= base_url('sak') ?>/cetak_pdf/<?= $sak->id_sak ?>')" class="btn btn-default btn-sm" title="Print">
                <i class="fas fa-print mr-2"></i>Cetak Surat
              </button>
							<?php endif ?>
              <a href="<?= base_url('sak/download_pdf/') . $sak->id_sak ?>" target="__blank" class="btn btn-default btn-sm" title="Download PDF">
