    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card">
            <div class="card-header">
              <!-- <a href="<?= base_url('sokp/buat') ?>" class="btn btn-primary"><i class="fas fa-plus-circle mr-2"></i>Buat SOKP</a> -->
              <h3 class="card-title">Buat Surat Observasi Kunjungan Perusahaan</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?= base_url('sokp/proses_buat') ?>" method="post">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-5">
                    ...
                    <input type="text" name="alamat_instansi" class="form-control" id="alamat_instansi" placeholder="Alamat Instansi :" required>
                  </div>
