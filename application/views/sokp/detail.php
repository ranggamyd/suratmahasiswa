      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('sokp') ?>">SOKP</a></li>
        ...
        <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $sokp->nama_mhs ?></h5>
              <h6><?= $sokp->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($sokp->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
