...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
        <a href="<?= base_url('spkl/buat') ?>" class="btn btn-primary btn-block mb-3"><i class="fas fa-pen mr-2"></i>Buat Surat SPKL Baru</a>
        ...
        <div class="card bg-gradient-primary">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="datatable" class="table table-striped bg-gradient-primary">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <?php if ($item['status_surat'] == 'Menunggu') : ?>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('spkl/terima/') . $item['id_spkl'] ?>">Selesai Dibuat</a>
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('spkl/tolak/') . $item['id_spkl'] ?>">Tolak Surat</a>
                            </div>
                          </div>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('spkl/detail/') . $item['id_spkl'] ?>" class="btn btn-info"><i class="fas fa-eye mr-2"></i>Lihat</a>
                        <a href="<?= base_url('spkl/edit/') . $item['id_spkl'] ?>" class="btn btn-success"><i class="fas fa-edit mr-2"></i>Edit</a>
                        <a href="<?= base_url('spkl/hapus/') . $item['id_spkl'] ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger"><i class="fas fa-trash mr-2"></i>Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
