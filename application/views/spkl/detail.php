      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('spkl') ?>">SPKL</a></li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $spkl->nama_mhs ?></h5>
              <h6><?= $spkl->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($spkl->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
            <div class="mailbox-controls with-border text-center">
              ...
              <button type="button" onclick="cetak_spkl('<?= base_url('spkl') ?>/cetak_pdf/<?= $spkl->id_spkl ?>')" class="btn btn-default btn-sm" title="Print">
                <i class="fas fa-print mr-2"></i>Cetak Surat
              </button>
							<?php endif ?>
              <a href="<?= base_url('spkl/download_pdf/') . $spkl->id_spkl ?>" target="__blank" class="btn btn-default btn-sm" title="Download PDF">
