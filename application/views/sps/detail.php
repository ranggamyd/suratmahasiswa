      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('sps') ?>">SPS</a></li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mailbox-read-info">
              <h5><?= $sps->nama_mhs ?></h5>
              <h6><?= $sps->nim ?>
                <span class="mailbox-read-time float-right"><?= date('d M Y', strtotime($sps->tgl_surat)) ?></span>
              </h6>
            </div>
            <!-- /.mailbox-read-info -->
