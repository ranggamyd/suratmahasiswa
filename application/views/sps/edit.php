            ...
            <input type="hidden" name="id" value="<?= $sps->id_sps ?>">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="no_surat" value="<?= $sps->no_surat ?>" class="form-control bg-light" id="no_surat" placeholder="No. Surat :" readonly required>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="nama_instansi" value="<?= $sps->nama_instansi ?>" class="form-control bg-light" id="nama_instansi" placeholder="Nama Instansi :" required>
                  </div>
                  <div class="form-group col-md-5">
                    <label for="alamat_instansi">Alamat Instansi</label>
                    <input type="text" name="alamat_instansi" value="<?= $sps->alamat_instansi ?>" class="form-control bg-light" id="alamat_instansi" placeholder="Alamat Instansi :" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="tgl_surat">Tanggal Surat</label>
                    <input type="date" name="tgl_surat" value="<?= $sps->tgl_surat ?>" class="form-control bg-light" id="tgl_surat" placeholder="Tanggal Surat :" readonly required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="perihal">Perihal</label>
                  <textarea name="perihal" class="form-control bg-light" id="perihal" rows="2" placeholder="Perihal :" required><?= $sps->perihal ?></textarea>
                </div>
                <div class="form-group">
                  <label for="summernote">Body Surat</label>
                  <textarea name="body_surat" id="summernote" class="form-control bg-light" style="height: 300px" required><?= $sps->body_surat ?></textarea>
                </div>
              </div>
              <!-- /.card-body -->
