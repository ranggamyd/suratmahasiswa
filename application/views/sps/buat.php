    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card">
            <div class="card-header">
              <!-- <a href="<?= base_url('sps/buat') ?>" class="btn btn-primary"><i class="fas fa-plus-circle mr-2"></i>Buat Sps</a> -->
              <h3 class="card-title">Buat Surat Penelitian Skripsi</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?= base_url('sps/proses_buat') ?>" method="post">
              <div class="card-body">
