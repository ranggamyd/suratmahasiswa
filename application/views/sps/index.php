                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <?php if ($item['status_surat'] == 'Menunggu') : ?>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('sps/terima/') . $item['id_sps'] ?>">Selesai Dibuat</a>
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin?')" href="<?= base_url('sps/tolak/') . $item['id_sps'] ?>">Tolak Surat</a>
                            </div>
                          </div>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('sps/detail/') . $item['id_sps'] ?>" class="btn btn-info"><i class="fas fa-eye mr-2"></i>Lihat</a>
                        <a href="<?= base_url('sps/edit/') . $item['id_sps'] ?>" class="btn btn-success"><i class="fas fa-edit mr-2"></i>Edit</a>
                        <a href="<?= base_url('sps/hapus/') . $item['id_sps'] ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger"><i class="fas fa-trash mr-2"></i>Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
